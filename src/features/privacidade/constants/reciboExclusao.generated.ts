 ...
 * Consumidor: ReciboExclusao do frontend (src/features/privacidade/)
 *
...
export const RECIBO_EXCLUSAO = {
  ...
  "colunas_sai": [
    ...
    },
    {
      ...
      "passo_motor_onde": "RPC SECURITY DEFINER de anonimização — planos 49-20 (D-48/D-62) e 49-21 (D-69), catorze statements antes da severação das ligações",
    ...
    },
    {
      ...
      "colunas_origem": [
        ...
        "ai_call_logs.user_prompt_template",
      ...
      "texto_futuro": "O conteúdo enviado para as análises automáticas e o texto que elas produziram sobre você vão ser apagados. Isso inclui as análises que compararam a sua candidatura com as de outras pessoas: o que foi enviado nelas também vai ser apagado.",
      "texto_passado": "O conteúdo enviado para as análises automáticas e o texto que elas produziram sobre você foram apagados. Isso inclui as análises que compararam a sua candidatura com as de outras pessoas: o que foi enviado nelas também foi apagado."
    },
    {
      "aplicavel_quando": "sempre",
      "classificacoes_origem": [
    ...
    },
    {
      ...
      "texto_futuro": "Vai ser apagada. No lugar dela fica o registro de que você pediu revisão, de que uma pessoa respondeu e em que data — sem ligação com você.",
      "texto_passado": "Foi apagada. No lugar dela ficou o registro de que você pediu revisão, de que uma pessoa respondeu e em que data — sem ligação com você."
    },
    {
      "aplicavel_quando": "sempre",
      "classificacoes_origem": [
  ...
  "fora_do_recibo": {
    ...
    "entrevista_analises.ai_call_log_id": "chave_tecnica",
    "entrevista_analises.modelo_ia": "estado_do_processo",
    "entrevista_analises.provedor_ia": "estado_do_processo",
    "entrevista_analises.revisada_por": "dado_de_funcionario",
    "entrevista_analises.solicitado_por": "dado_de_funcionario",
    "entrevista_analises.superada_em": "estado_do_processo",
    "entrevista_analises.texto_hash": "chave_tecnica",
    "entrevista_analises.tipo": "estado_do_processo",
  ...
  "passos_motor_onde": {
    "apagar_respostas_e_producoes": "RPC SECURITY DEFINER de anonimização — planos 49-20 (D-48/D-62) e 49-21 (D-69), catorze statements antes da severação das ligações",
