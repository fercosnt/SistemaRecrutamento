...
| 6 | 45 | deviation | .planning/phases/45-motor-de-exclus-o-anonimiza-o/45-02-SUMMARY.md |  | 45-02: 6 das 9 bases legais do recibo foram escritas pela engenharia, nao ditadas pela UI-SPEC — revisao pelo Encarregado de Dados pendente antes do e-mail de recibo sair em PROD | fixed | FECHADO por DECISAO em 2026-08-13 (.planning/DECISAO-ENCARREGADO.md): a revisao pelo Encarregado NAO vai acontecer porque a empresa decidiu nao designar Encarregado. A decisao sobre as nove bases legais passa a ser do OPERADOR, com nome e data. ⚠ REGISTRO HONESTO, e ele importa: isto roteia a decisao, NAO valida juridicamente as seis bases que a engenharia escreveu. Elas seguem sendo o melhor mapeamento da engenharia — o que mudou e que agora ha um decisor nomeado em vez de uma pendencia fantasma esperando alguem que nao viria. | 2026-08-05T04:13:18.664Z | 2026-08-13T00:00:00.000Z |
| 7 | 45 | unrun-verify | supabase/tests/p45_bias_k5_smoke.sql |  | p45_bias_k5_smoke.sql e o DO de auto-verificacao da 20260805000003 nunca foram executados contra banco nenhum — o apply e 45-11 | fixed | FECHADO: a migration 20260805000003 esta APLICADA (ledger conferido em 2026-08-13), logo o DO de auto-verificacao dela EXECUTOU no apply. O p45_bias_k5_smoke.sql passou 9/9 em PROD conforme registrado no STATE.md — ERASE-01 provado. | 2026-08-05T07:10:20.368Z | 2026-08-13T00:00:00.000Z |
...
| 9 | 45 | unrun-verify | supabase/tests/p45_motor_exclusao_smoke.sql |  | Smoke do motor de exclusao NAO executado — deliberadamente RED (as 5 funcoes nascem em 45-03/45-05/45-07); os pins md5(prosrc) seguem com marcador PENDENTE-45-07 e C3 reprova enquanto assim for. Fecha no 45-11 com 21/21 PASS | fixed | FECHADO por EXECUCAO em 2026-08-13: o operador rodou o smoke inteiro em PROD numa unica chamada e ele passou — contador 24/24, zero residuo nas 13 tabelas. Os pins md5(prosrc) foram preenchidos em 6aa249a com conferencia CRUZADA (corpo vivo x corpo do arquivo commitado: md5 E octetos batendo nas duas funcoes), entao o C3 deixou de reprovar por marcador e passou a MORDER de verdade. O run tambem provou POR EXECUCAO os consertos CR-01 e CR-02 do 76976bb, que ate entao so tinham verificacao por forma. | 2026-08-05T07:14:13.436Z | 2026-08-13T00:00:00.000Z |
...
| 11 | 45 | unrun-verify | supabase/migrations/20260805000001_p45_pedido_exclusao.sql |  | As duas migrations do 45-03 foram escritas mas NAO aplicadas — o DO block de auto-verificacao so executa no apply (45-06) | fixed | FECHADO: 20260805000001 e 20260805000002 estao no ledger (conferido em 2026-08-13), logo os DO blocks de auto-verificacao das duas EXECUTARAM no apply. | 2026-08-05T07:23:32.301Z | 2026-08-13T00:00:00.000Z |
...
| 14 | 45 | deviation | supabase/functions/executar-direito-titular/index.ts | 377 | DI-45-07-01: a EF chama as RPCs com service_role sem repassar o Authorization do titular; auth.uid() e NULL e o guard das RPCs ja aplicadas em PROD recusa com 42501 — nenhum pedido de exclusao seria registrado. Fecha no 45-10. | fixed | FECHADO: o DI-45-07-01 foi resolvido. A EF tem o TERCEIRO client `supabaseTitular` (service key no apikey + Authorization do titular), a migration 20260805000009 de GRANT esta aplicada e a EF foi redeployada (v2). As tres partes indivisiveis fechadas. | 2026-08-05T23:11:21.892Z | 2026-08-13T00:00:00.000Z |
| 15 | 45 | unrun-verify | supabase/migrations/20260805000006_p45_anonimizar_candidato.sql |  | Os DO blocks de auto-verificacao das 3 migrations do 45-07 so EXECUTAM no apply, que e do 45-11 atras do portao destrutivo. Ate la a verificacao e estatica (forma), nao por execucao. | fixed | FECHADO: as tres migrations do 45-07 (20260805000005/000006/000007) estao no ledger (conferido em 2026-08-13). Os DO blocks de auto-verificacao EXECUTARAM no apply, entao a verificacao delas deixou de ser estatica e passou a ser por execucao. | 2026-08-05T23:11:21.947Z | 2026-08-13T00:00:00.000Z |
...
| 17 | 45 | stub | src/features/vagas/hooks/useRetirarCandidatura.ts |  | O hook invoca a EF executar-direito-titular com acao 'retirar_candidatura', mas o vocabulario FECHADO dela e ACOES={pedir,cancelar} (index.ts:137). O caminho do candidato NAO funciona ate o 45-10 acrescentar a acao e repassar as claims do titular (DI-45-07-01). | fixed | FECHADO: ACOES da EF passou a ser {pedir, cancelar, executar, retirar_candidatura} (index.ts:263). O caminho do candidato deixou de morrer em 400 VALIDATION. | 2026-08-06T05:00:05.428Z | 2026-08-13T00:00:00.000Z |
...
| 19 | 45 | unrun-verify | supabase/migrations/20260805000007_p45_retirada_e_evento.sql |  | As duas migrations do plano foram AUTORADAS e nao aplicadas (por desenho: quem aplica e o 45-11). Os blocos DO de auto-verificacao, o gate de md5 do BLOCO G e o caminho ponta a ponta so sao exercitados no apply. | fixed | FECHADO: 20260805000007 e 20260805000008 estao no ledger (conferido em 2026-08-13). Os DO blocks, o gate de md5 do BLOCO G e o caminho foram exercitados no apply. | 2026-08-06T05:00:05.540Z | 2026-08-13T00:00:00.000Z |
| 20 | 45 | deviation | supabase/functions/executar-direito-titular/index.ts |  | DI-45-10-01: as 4 chamadas de RPC usam supabaseAdmin sem repassar o Authorization do titular; auth.uid() e NULL e as RPCs recusam com 42501 — o motor nao roda ponta a ponta | fixed | FECHADO: o DI-45-10-01 foi resolvido — as chamadas de RPC passaram a usar o client que repassa o Authorization do titular (`supabaseTitular`), com o GRANT da 20260805000009 aplicado e a EF redeployada. | 2026-08-06T15:22:17.025Z | 2026-08-13T00:00:00.000Z |
| 21 | 45 | deviation | supabase/functions/executar-direito-titular/index.ts |  | DI-45-10-02: ACOES nao conhece 'retirar_candidatura' e o hook do 45-09 invoca a EF com essa acao — 400 VALIDATION traduzido para SERVER_ERROR na tela | fixed | FECHADO: o DI-45-10-02 foi resolvido — retirar_candidatura entrou no vocabulario de ACOES (index.ts:263). | 2026-08-06T15:22:17.081Z | 2026-08-13T00:00:00.000Z |
| 22 | 45 | deviation | supabase/tests/p45_motor_exclusao_smoke.sql |  | C1 exige que gerar_bias_snapshot nao conceda EXECUTE a authenticated, mas 20260805000003 o concede deliberadamente (chamador vivo: biasAuditService.ts:98) — DI-45-12-01, decisao do code review bloqueante do 45-11 | fixed | FECHADO por DECISAO DO CODE REVIEW BLOQUEANTE nº 4 em 2026-08-12 (45-REVIEW-4.md / CR-02), que e exatamente o portao ao qual o 45-12 enderecou o DI-45-12-01. VEREDITO: o ACL esta CERTO, a premissa da assercao estava errada — consertar a assercao, NUNCA revogar. Revogar apagaria a tela de auditoria de vies, peca PROBATORIA de nao-discriminacao (RNF-07a): seria o espelho do movimento proibido de relaxar FK para CASCADE diante de um 23503. Aplicado em 76976bb, com a expectativa de ACL passando a ser DECLARADA por funcao (v_concede_auth/v_nega_auth) em vez de derivada de «e chamada pela Edge Function?», mais checagem fail-closed de classificacao. | 2026-08-06T17:15:24.030Z | 2026-08-13T00:00:00.000Z |
...
| 34 | 47 | deviation | src/services/logAccessService.ts | 22 |  O vocabulario de `EventoAcesso` do TS e o CHECK `check_evento` do banco DIVERGEM, e o log de acesso esta MORTO na pratica. O tipo declara 8 valores; o CHECK aceita 8 OUTROS; a intersecao e de 3 (login_sucesso, login_falha, logout). Os 5 ilegais sao sessao_expirada, acesso_negado, password_reset_request, password_reset_completed e password_reset_failed — e `sessao_expirada` e exatamente o que o UNICO chamador vivo manda (useSessionTimeout.ts:76). Aquele INSERT falha com 23514 em TODA execucao, e logAccessEvent ENGOLE o erro de proposito (console.error, sem throw). MEDIDO: a tabela so tem login_sucesso (21) e login_falha (2), e a ultima linha e de 2026-04-20 — quatro meses sem registro. ⚠ Achado POR ACIDENTE: a sonda da migration 20260813000001 usou um evento invalido e o apply abortou com 23514, expondo o CHECK. CONSERTO exige DECISAO: alargar o CHECK para os valores pt-BR que faltam, ou alinhar o TS ao vocabulario do banco. Nao foi feito de carona na migration do IP — mudar constraint de dominio dentro de uma migration sobre outra coisa e como o drift entra. | fixed | FECHADO em 2026-08-22 (9965523 + apply). ALARGADO o CHECK com quatro conceitos pt-BR (sessao_expirada, acesso_negado, senha_reset_solicitada, senha_reset_falhou) e renomeados no TS os tres password_reset_* — os 8 valores antigos PRESERVADOS, nenhum removido (estreitar CHECK de dominio pode invalidar linha existente; alargar nunca pode). A direcao nao era simetrica e foi ela que decidiu: o banco NAO TINHA conceito para «sessao expirou» nem «acesso negado», entao alinhar o TS ao banco era impossivel para metade dos casos. ⚠ A CAUSA ESTRUTURAL tambem foi fechada: eram DUAS listas em DOIS lugares com ZERO mecanismo comparando. EVENTOS_ACESSO passou a existir em RUNTIME, o tipo deriva dele, e logAccessVocabulario.test.ts le o SQL da migration e compara nos dois sentidos, mais dois casos que medem o CODIGO (o que o servico emite, e o chamador vivo do hook). Prova por mutacao: removendo sessao_expirada do TS, 2 dos 3 casos falham. Verificado no catalogo vivo: 12/12 valores presentes, 23 linhas, zero residuo de sonda. | 2026-08-22T00:00:00.000Z | 2026-08-22T00:00:00.000Z |
