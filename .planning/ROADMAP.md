...
| 4. Vagas + Candidatura | 5/8 | Waves 0-2 complete (04-01 schema/stubs; 04-02 vagasService slug + isUuid + vagasKeys ext.; 04-03 cvUploadService + 14 Vitest; 04-04 PerguntaFormulario + buildCandidaturaSchema + useVagaPerguntas + 17 Vitest; 04-05 submit-candidatura Edge Function deployed live + service wrapper + 7 Vitest cases); 54/54 Vitest tests pass post-Wave-2; Wave 2 close note: EF deployed to project isljnozzlvckrgjjbjwp ACTIVE version 1 with verify_jwt ON; 3 smokes verde (deploy + anon 401 + auth empty body 400 VALIDATION); D-23 two-client EF pattern + D-24 Zod default messages preserved both LOCKED. Wave 3 (04-06 routes + 04-07 FormularioCandidaturaPage rewrite — both consume submitCandidaturaWithRespostas wrapper) next | - |
