...
- [x] 25-08-PLAN.md — Re-measure + re-pin ci.yml tsc baseline (stale 133 -> measured) (FUNIL-04) [Wave 2]
...
- [x] 27-02-PLAN.md — CI-07 shared-`zod` contract (deno.json map + bare-zod _shared + migrate 3 contract tests + consolidar EF) + CI-13 config.toml (CI-07/13) [Wave 1]
- [x] 27-04-PLAN.md — DBMIG-02 trigger fix + backfill (migration files) + "49→71" count correction (DBMIG-02/01) [Wave 1]
