...
- [x] 47-08-PLAN.md — `RodapePublico` e a alcançabilidade, atrás do portão de publicação do Encarregado (TRANSP-01/02) · o bloqueio de **fato** do 47-04 caiu em 2026-08-11; o que resta é o portão de **publicação**, que é outro
- [x] 47-09-PLAN.md — o checklist versionado de promessas com executor + a varredura de destinos de rede (CONSOL-04)
...
- [x] 48-05-PLAN.md — Devolutiva do Big Five: instrumentação → submissão de prova (checkpoint) → conserto derivado da causa medida → geração retroativa do backlog de teste pelo operador no painel, recusável (checkpoint) (JORN-06)
...
- [x] 48-08-PLAN.md — Chave de dedupe por transição (`historico_id`) e por ciclo de revisão (`ciclo`) (JORN-18, JORN-20)
- [x] 48-09-PLAN.md — Explicação da rejeição na triagem (RPC tri-estado + página) e `feedback_rejeicao` neutro na rejeição humana (JORN-22)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 48-10-PLAN.md — Liberação da avaliação cognitiva passa a avisar o candidato (D-22 · JORN-15)
- [x] 48-11-PLAN.md — Reabrir, não reverter: `responder_revisao_decisao` reabre com prazo de 10 dias; `registrar_decisao` com D-23, fail-closed e zeragem do ciclo (JORN-19)
- [x] 48-12-PLAN.md — Escritas retroativas por decisão do operador: ensaio revertido → checkpoint → migrations com portão (JORN-26, JORN-22)
...
- [x] 49-09-PLAN.md — Redação pela rubrica BARS do PRD numa constante única, com checagem pós-parse e proveniência real (JORN-07, JORN-28)
...
- [ ] 49-25-PLAN.md — Bloqueio pré-provedor não vira guia pronto: teto de custo estourado persiste `incompleto` + `cost_cap_exceeded` em vez de guia vazio com `{ok:true}` (JORN-28, JORN-39 — WINDOWS 60, acrescentado 2026-09-23 por decisão do operador)
...
- [x] 49-11-PLAN.md — Proveniência da análise da triagem e as 7 EFs de IA no contrato novo (JORN-28, JORN-39)
- [x] 49-13-PLAN.md — Comparativo da vaga na tela e no PDF: rótulo pela chave e selo de proveniência (JORN-25, JORN-28)
...
| 49. Consertos da Jornada — Bloco 2 | v8.0 | 14/25 | In Progress|  |
