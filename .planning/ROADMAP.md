...
- [ ] 05-07-PLAN.md — Gap-closure (GAP-05-CI-1..5): BackgroundImage solid dark base layer fixes axe color-contrast on all public glass routes (SC4/HARD-04) + gate cadastro happy-path Tier-2 (GAP-1) + mock vagas list B-J01 (GAP-2) + mock candidatos in recovery B10 so it reaches /candidato/perfil (GAP-3) → full chromium suite green under CI-condition (SC2/HARD-01)
...
| 5. Perfil + Hardening MVP | 6/7 | Gaps found (first live CI run RED) — gap-closure plan 05-07 created (5 CI/a11y gaps) | 2026-06-06 |
