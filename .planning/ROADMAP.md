...
| 4.1. Auth Hydration Fix (INSERTED) | 1/5 | Wave 0 complete (Plan 01: 6 test artifacts — Vitest authStore + found12 + RoleGuard scaffolds + Playwright auth-hydration spec + B-J12 + Pitfall 7 RoleGuard coverage; 9 RED+GREEN assertions; tsc baseline 320 → 296 net −24 via jest-dom shim) — Wave 1 next: hydrateFromSession action + App.tsx setTimeout(0) listener + RoleGuard fallbackTriedRef | - |
