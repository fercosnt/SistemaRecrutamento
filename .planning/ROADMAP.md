...
- **Plans:** 5 plans
  - [ ] 17-01-PLAN.md — Wave 0 RED test battery (funilNavMap + route-table + RHSidebar-admin + hub-empty-state + legacy grep guard + Playwright nav smoke) — D-03/D-16
  - [ ] 17-02-PLAN.md — Foundation: funilNavMap single source + NotFoundPage glass 404 + routes.tsx catch-all + normalization redirect — D-17/D-14/D-08/D-15/D-02
  - [ ] 17-03-PLAN.md — RH funnel: hub-candidato feature (mock retired) + TriagemTable SPA entry + role-gated Admin sidebar — D-04/D-05/D-06/D-07/D-13/D-15
  - [ ] 17-04-PLAN.md — Candidate funnel: Dashboard step-CTA + LGPD card + landing repoint + Perfil strip — D-09/D-10/D-11
