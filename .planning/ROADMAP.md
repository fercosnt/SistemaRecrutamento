...
| 4. Vagas + Candidatura | 7/8 | Waves 0-3 complete (04-01..05 + 04-06 VagaDetalhePage slug routing + 404 + login redirect builder + VagasPage orphan deleted + 04-07 FormularioCandidaturaPage full rewrite + VAGA-03 LoginCandidatoPage redirect fix with anti-open-redirect guard); 65/65 Vitest tests pass post-Wave-3 (added 11 LoginCandidatoPage redirect cases); lint baseline improved Phase 3 close 354 → Phase 4 Wave 3 close 320 (−34 from legacy code purges); build green; only 04-08 (Wave 4 — E2E promotion + UAT runbook + final verification) remaining | - |
