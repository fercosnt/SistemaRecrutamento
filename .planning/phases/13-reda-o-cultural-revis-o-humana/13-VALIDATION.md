...
| 1 | 13-04 | AVAL-05/06/07 | T-13-* | migrations applied PROD via MCP + culture_fit_essay is_active=true + EF deployed + types regen + ALL smokes live | sql-smoke | SMOKE-1..8 live | ⬜ pending |
