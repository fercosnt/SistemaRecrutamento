...
export const EXPORT_ALLOWLIST = {
  ...
  "meta": {
    ...
    "gerado_em": "2026-09-24T05:24:24.587Z",
    ...
    "totais": {
      "colunas_colhidas": 763,
      "colunas_com_veredito_em_escopo": 427,
      "colunas_excluidas_em_escopo": 49,
  ...
  "tabelas": {
    ...
    "analise_candidato_vaga": {
      ...
      "colunas_excluidas": {
        ...
        "modelo_ia": "decisoes_por_coluna: (i) telemetria_interna — qual modelo rodou. Idem `analise_candidato_vaga.provedor_ia`.",
      ...
      "proveniencia": {
        "candidatura_id": "R1",
        "created_at": "R1",
        "descartada_em": "decisoes_por_coluna",
        "descartada_motivo": "decisoes_por_coluna",
    ...
    "redacoes_candidato": {
      ...
      "colunas_excluidas": {
        ...
        "modelo_ia": "decisoes_por_coluna: (i) telemetria_interna — qual modelo rodou. Idem `redacoes_candidato.provedor_ia` e `redacoes_candidato.model_version`.",
        ...
        "provedor_ia": "decisoes_por_coluna: (i) telemetria_interna — qual provedor de LLM avaliou a redação (D-28). Idem `entrevista_analises.provedor_ia`, e a família desta tabela já estava decidida assim: `model_version` e `prompt_version`, vizinhas dela, saem pela mesma razão desde a 44-01.",
