...
export const BAND_TEMPLATES: Record<Dim, Record<Banda, string>> = {
  O: {
    ...
    mod_baixo:
      "Pessoas com Abertura moderadamente baixa costumam preferir o conhecido ao novo, sem rejeitar mudanças quando bem fundamentadas. Tendem a confiar em métodos testados, valorizar a experiência acumulada, e abordar inovações com um saudável ceticismo antes de adotá-las. Ambientes onde mudanças vêm com justificativa clara e treinamento estruturado tendem a ser mais naturais. Contextos que pedem reinvenção rápida podem exigir esforço adicional.",
    medio:
